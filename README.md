...
## How do I use it?
This repo contains one branch per active LTS release and a `developer` branch for the development only version. The branch naming structure will be in the following format: `lts/v2025.2.LTS`.
...
With individual LTS branches, it is possible to see the code diff between any two LTS versions here on GitHub. For example, if you are currently using `v2025.1.LTS` and are upgrading to `v2025.2.LTS` you will be able to use the following link to check for all styling differences:

[https://github.com/Learnosity/learnosity-apis-css/compare/lts/v2025.1.LTS..lts/v2025.2.LTS?w=1](https://github.com/Learnosity/learnosity-apis-css/compare/lts/v2025.1.LTS..lts/v2025.2.LTS?w=1)
* The base URL tells GitHub to compare branches - https://github.com/Learnosity/learnosity-apis-css/compare/
* The two versions listed tell GitHub to compare from v2025.1.LTS to v2025.2.LTS - `lts/v2025.1.LTS..lts/v2025.2.LTS`
...
The CSS files listed below are prettified versions of the compiled production code.
...
* [help.learnosity.com](http://help.learnosity.com/hc/en-us) -- general help portal and tutorials, developer reference material, and
